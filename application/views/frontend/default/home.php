        ...
        <div class="container-lg">
            <div class="row">
                <div class="col">
                    <h3 class="text-center mb-5">
                        <span class="header-underline-2"><?php echo site_phrase('popular_instructors'); ?></span>
                    </h3>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-9 col-lg-7 ">
                    <div class="instructor-summary top-istructor-slick">
                        <div class="animated-loader"><div class="spinner-border text-secondary" role="status"></div></div>
                        <?php foreach($top_instructor_ids as $top_instructor_id): ?>
                            ...
                            <div class="">
                                <div class="instructor-image">
                                    <img class="image-fluid radius-top-8" src="<?php echo $this->user_model->get_user_image_url($top_instructor['id']); ?>">
                                </div>
                                <div class="summary-box">
                                    <div class="summary-body ellipsis-line-2">
                                        <?php echo $top_instructor['title']; ?>
                                    </div>
                                    <div class="summary-footer">
                                        <div class="skills">
                                            <?php $skills = explode(',', $top_instructor['skills']); ?>
                                            <?php foreach($skills as $skill): ?>
                                              <span class="badge text-12px my-1 py-1 fw-500"><?php echo $skill; ?></span>
                                            <?php endforeach; ?>
                                        </div>

                                        <div class="name">
                                            <h6>
                                                <a class="text-white" href="<?php echo site_url('home/instructor_page/'.$top_instructor['id']); ?>"><?php echo $top_instructor['first_name'].' '.$top_instructor['last_name']; ?></a>
                                            </h6>
                                            <span><?php echo site_phrase('instructor'); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6 text-center">
                            <i onclick="$('.slick-prev').click();" class="fas fa-long-arrow-alt-left cursor-pointer"></i>
                        </div>
                        <div class="col-6 text-center">
                            <i onclick="$('.slick-next').click();" class="fas fa-long-arrow-alt-right cursor-pointer"></i>
                        </div>
                    </div>
                </div>
            </div>
